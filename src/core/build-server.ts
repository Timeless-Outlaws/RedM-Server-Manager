...
export default class BuildServer {
     ...
     */
    constructor(behaivour = 'latest', url = 'http://runtime.fivem.net/artifacts/fivem/build_proot_linux/master') {
     ...
     *
     * @return {Promise<BuildInformation>} Will resolve once the build information is fetched containing the information
     */
